...
aus_morning_early_tripconfig = Tripconfig("Austin Morning Early Shuttle",'MTWTF','False',shuttle_big)
aus_morning_late_tripconfig = Tripconfig("Austin Morning Late Shuttle",'TWT','False', shuttle_small)
aus_evening_early_tripconfig = Tripconfig("Austin Evening Early Shuttle",'MTWTF','True',shuttle_big)
aus_evening_late_tripconfig = Tripconfig("Austin Evening Late Shuttle",'TWT','True',shuttle_small)
